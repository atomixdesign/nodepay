  ...
  CustomerDetails
{
  ...
  async chargeRecurring(
    ...
    const scheduleObject = {
      ...
      DayOfMonth: paymentSchedule.dayOfMonth ?? 0,
      ...
      LimitToNumberOfPayments: paymentSchedule.maxNumberPayments ?? 0,
      LimitToTotalAmountInCents: paymentSchedule.maxTotalAmount ?? 0,
